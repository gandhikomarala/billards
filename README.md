# CueMasters Pro — 8-Ball & Snooker Rigid Body Physics Engine

Continuous collision detection, angular momentum spin calculation, and table friction simulation engine.
