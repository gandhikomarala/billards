namespace CueMasters.Table
{
    ...
    /// <summary>
    /// Billiards Table Physical Dimensions & Felt Finish #069
    /// Controls cloth rolling friction, rail cushion bounciness, and pocket drop radiuses.
    /// </summary>
    [CreateAssetMenu(fileName = "TableDefinition_069", menuName = "CueMasters/Table #069")]
    public class BilliardsTableCatalog_069 : ScriptableObject
    {
        public enum FeltColor { TournamentGreen, RoyalBlue, ObsidianSlate, RubyLuxury, CyberNeon }

        [SerializeField] private string tableId = "TABLE_069";
        [SerializeField] private string tableTitle = "Tournament Table #069";
