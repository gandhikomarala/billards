namespace CueMasters.Table
{
    ...
    /// <summary>
    /// Billiards Table Physical Dimensions & Felt Finish #075
    /// Controls cloth rolling friction, rail cushion bounciness, and pocket drop radiuses.
    /// </summary>
    [CreateAssetMenu(fileName = "TableDefinition_075", menuName = "CueMasters/Table #075")]
    public class BilliardsTableCatalog_075 : ScriptableObject
    {
        public enum FeltColor { TournamentGreen, RoyalBlue, ObsidianSlate, RubyLuxury, CyberNeon }

        [SerializeField] private string tableId = "TABLE_075";
        [SerializeField] private string tableTitle = "Tournament Table #075";
