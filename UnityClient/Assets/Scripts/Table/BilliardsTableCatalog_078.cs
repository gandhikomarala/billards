namespace CueMasters.Table
{
    ...
    /// <summary>
    /// Billiards Table Physical Dimensions & Felt Finish #078
    /// Controls cloth rolling friction, rail cushion bounciness, and pocket drop radiuses.
    /// </summary>
    [CreateAssetMenu(fileName = "TableDefinition_078", menuName = "CueMasters/Table #078")]
    public class BilliardsTableCatalog_078 : ScriptableObject
    {
        public enum FeltColor { TournamentGreen, RoyalBlue, ObsidianSlate, RubyLuxury, CyberNeon }

        [SerializeField] private string tableId = "TABLE_078";
        [SerializeField] private string tableTitle = "Tournament Table #078";
