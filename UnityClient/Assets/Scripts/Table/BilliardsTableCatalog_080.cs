namespace CueMasters.Table
{
    ...
    /// <summary>
    /// Billiards Table Physical Dimensions & Felt Finish #080
    /// Controls cloth rolling friction, rail cushion bounciness, and pocket drop radiuses.
    /// </summary>
    [CreateAssetMenu(fileName = "TableDefinition_080", menuName = "CueMasters/Table #080")]
    public class BilliardsTableCatalog_080 : ScriptableObject
    {
        public enum FeltColor { TournamentGreen, RoyalBlue, ObsidianSlate, RubyLuxury, CyberNeon }

        [SerializeField] private string tableId = "TABLE_080";
        [SerializeField] private string tableTitle = "Tournament Table #080";
