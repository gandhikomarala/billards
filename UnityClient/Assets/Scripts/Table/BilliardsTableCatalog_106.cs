namespace CueMasters.Table
{
    ...
    /// <summary>
    /// Billiards Table Physical Dimensions & Felt Finish #106
    /// Controls cloth rolling friction, rail cushion bounciness, and pocket drop radiuses.
    /// </summary>
    [CreateAssetMenu(fileName = "TableDefinition_106", menuName = "CueMasters/Table #106")]
    public class BilliardsTableCatalog_106 : ScriptableObject
    {
        public enum FeltColor { TournamentGreen, RoyalBlue, ObsidianSlate, RubyLuxury, CyberNeon }

        [SerializeField] private string tableId = "TABLE_106";
        [SerializeField] private string tableTitle = "Tournament Table #106";
