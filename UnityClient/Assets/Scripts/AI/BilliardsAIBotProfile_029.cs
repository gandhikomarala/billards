namespace CueMasters.AI
{
    ...
    /// <summary>
    /// Deterministic Billiards AI Opponent Profile #029
    /// Calculates ghost ball target lines, pocket cut angles, and applies deliberate difficulty error cones.
    /// </summary>
    [CreateAssetMenu(fileName = "AIProfile_029", menuName = "CueMasters/AI Profile #029")]
    public class BilliardsAIBotProfile_029 : ScriptableObject
    {
        public enum Difficulty { Easy, Medium, Hard, Pro }

        [SerializeField] private string botName = "Pool Master AI #029";
