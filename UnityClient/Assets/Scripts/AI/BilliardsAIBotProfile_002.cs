namespace CueMasters.AI
{
    ...
    /// <summary>
    /// Deterministic Billiards AI Opponent Profile #002
    /// Calculates ghost ball target lines, pocket cut angles, and applies deliberate difficulty error cones.
    /// </summary>
    [CreateAssetMenu(fileName = "AIProfile_002", menuName = "CueMasters/AI Profile #002")]
    public class BilliardsAIBotProfile_002 : ScriptableObject
    {
        public enum Difficulty { Easy, Medium, Hard, Pro }

        [SerializeField] private string botName = "Pool Master AI #002";
