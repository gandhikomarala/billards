namespace CueMasters.AI
{
    ...
    /// <summary>
    /// Deterministic Billiards AI Opponent Profile #048
    /// Calculates ghost ball target lines, pocket cut angles, and applies deliberate difficulty error cones.
    /// </summary>
    [CreateAssetMenu(fileName = "AIProfile_048", menuName = "CueMasters/AI Profile #048")]
    public class BilliardsAIBotProfile_048 : ScriptableObject
    {
        public enum Difficulty { Easy, Medium, Hard, Pro }

        [SerializeField] private string botName = "Pool Master AI #048";
