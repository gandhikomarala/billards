namespace CueMasters.AI
{
    ...
    /// <summary>
    /// Deterministic Billiards AI Opponent Profile #116
    /// Calculates ghost ball target lines, pocket cut angles, and applies deliberate difficulty error cones.
    /// </summary>
    [CreateAssetMenu(fileName = "AIProfile_116", menuName = "CueMasters/AI Profile #116")]
    public class BilliardsAIBotProfile_116 : ScriptableObject
    {
        public enum Difficulty { Easy, Medium, Hard, Pro }

        [SerializeField] private string botName = "Pool Master AI #116";
