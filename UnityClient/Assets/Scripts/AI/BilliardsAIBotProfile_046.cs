namespace CueMasters.AI
{
    ...
    /// <summary>
    /// Deterministic Billiards AI Opponent Profile #046
    /// Calculates ghost ball target lines, pocket cut angles, and applies deliberate difficulty error cones.
    /// </summary>
    [CreateAssetMenu(fileName = "AIProfile_046", menuName = "CueMasters/AI Profile #046")]
    public class BilliardsAIBotProfile_046 : ScriptableObject
    {
        public enum Difficulty { Easy, Medium, Hard, Pro }

        [SerializeField] private string botName = "Pool Master AI #046";
