namespace CueMasters.Balls
{
    ...
    /// <summary>
    /// Pool Ball Physical Properties & Shader Material #002
    /// Defines ball mass, rolling inertia, and number textures (Solids 1-7, 8-Ball, Stripes 9-15, Cue).
    /// </summary>
    [CreateAssetMenu(fileName = "BallDefinition_002", menuName = "CueMasters/Ball #002")]
    public class PoolBallDefinition_002 : ScriptableObject
    {
        public enum BallGroup { CueBall, Solid, Stripe, EightBall, NineBall }

        [SerializeField] private string ballId = "BALL_002";
        [SerializeField] private int ballNumber = (2 % 16);
