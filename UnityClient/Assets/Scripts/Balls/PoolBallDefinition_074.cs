namespace CueMasters.Balls
{
    ...
    /// <summary>
    /// Pool Ball Physical Properties & Shader Material #074
    /// Defines ball mass, rolling inertia, and number textures (Solids 1-7, 8-Ball, Stripes 9-15, Cue).
    /// </summary>
    [CreateAssetMenu(fileName = "BallDefinition_074", menuName = "CueMasters/Ball #074")]
    public class PoolBallDefinition_074 : ScriptableObject
    {
        public enum BallGroup { CueBall, Solid, Stripe, EightBall, NineBall }

        [SerializeField] private string ballId = "BALL_074";
        [SerializeField] private int ballNumber = (74 % 16);
