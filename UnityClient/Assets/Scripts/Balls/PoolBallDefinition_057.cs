namespace CueMasters.Balls
{
    ...
    /// <summary>
    /// Pool Ball Physical Properties & Shader Material #057
    /// Defines ball mass, rolling inertia, and number textures (Solids 1-7, 8-Ball, Stripes 9-15, Cue).
    /// </summary>
    [CreateAssetMenu(fileName = "BallDefinition_057", menuName = "CueMasters/Ball #057")]
    public class PoolBallDefinition_057 : ScriptableObject
    {
        public enum BallGroup { CueBall, Solid, Stripe, EightBall, NineBall }

        [SerializeField] private string ballId = "BALL_057";
        [SerializeField] private int ballNumber = (57 % 16);
