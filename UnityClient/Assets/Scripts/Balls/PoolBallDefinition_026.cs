namespace CueMasters.Balls
{
    ...
    /// <summary>
    /// Pool Ball Physical Properties & Shader Material #026
    /// Defines ball mass, rolling inertia, and number textures (Solids 1-7, 8-Ball, Stripes 9-15, Cue).
    /// </summary>
    [CreateAssetMenu(fileName = "BallDefinition_026", menuName = "CueMasters/Ball #026")]
    public class PoolBallDefinition_026 : ScriptableObject
    {
        public enum BallGroup { CueBall, Solid, Stripe, EightBall, NineBall }

        [SerializeField] private string ballId = "BALL_026";
        [SerializeField] private int ballNumber = (26 % 16);
