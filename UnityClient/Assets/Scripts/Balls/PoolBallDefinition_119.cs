namespace CueMasters.Balls
{
    ...
    /// <summary>
    /// Pool Ball Physical Properties & Shader Material #119
    /// Defines ball mass, rolling inertia, and number textures (Solids 1-7, 8-Ball, Stripes 9-15, Cue).
    /// </summary>
    [CreateAssetMenu(fileName = "BallDefinition_119", menuName = "CueMasters/Ball #119")]
    public class PoolBallDefinition_119 : ScriptableObject
    {
        public enum BallGroup { CueBall, Solid, Stripe, EightBall, NineBall }

        [SerializeField] private string ballId = "BALL_119";
        [SerializeField] private int ballNumber = (119 % 16);
