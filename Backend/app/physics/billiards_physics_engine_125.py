"""
CueMasters Pro — 2D Rigid Body Billiards Physics Engine Module 125
...
class BilliardsPhysicsEngine125:
    """
    Sub-step continuous physics solver for billiard table 125.
    """
    ...
    def step_simulation(self, balls: List[Ball2D_125], dt: float = 0.016) -> bool:
