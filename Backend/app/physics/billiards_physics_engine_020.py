"""
CueMasters Pro — 2D Rigid Body Billiards Physics Engine Module 020
...
class BilliardsPhysicsEngine020:
    """
    Sub-step continuous physics solver for billiard table 020.
    """
    ...
    def step_simulation(self, balls: List[Ball2D_020], dt: float = 0.016) -> bool:
