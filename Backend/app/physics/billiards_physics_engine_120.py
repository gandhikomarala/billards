"""
CueMasters Pro — 2D Rigid Body Billiards Physics Engine Module 120
...
class BilliardsPhysicsEngine120:
    """
    Sub-step continuous physics solver for billiard table 120.
    """
    ...
    def step_simulation(self, balls: List[Ball2D_120], dt: float = 0.016) -> bool:
