"""
CueMasters Pro — 2D Rigid Body Billiards Physics Engine Module 130
...
class BilliardsPhysicsEngine130:
    """
    Sub-step continuous physics solver for billiard table 130.
    """
    ...
    def step_simulation(self, balls: List[Ball2D_130], dt: float = 0.016) -> bool:
