 ...
 * Project: CueMasters Pro — 8-Ball & Snooker Rigid Body Physics Engine
 */
...
export class EnterpriseEngine_758 {
  ...
  constructor(private readonly namespace: string = "CueMasters Pro — 8-Ball & Snooker Rigid Body Physics Engine") {}
